...
if __name__ == "__main__":
    ...
    print(f"Num Islands: {num_islands(grid)}")
    
    # Test 2: Friend Circles
    is_connected = [[1,1,0],[1,1,0],[0,0,1]]
    print(f"Find Circle Num: {find_circle_num(is_connected)}")
    
    # Test 3: Graph Valid Tree
    print(f"Valid Tree(5, [[0,1],[0,2],[0,3],[1,4]]): {valid_tree(5, [[0,1],[0,2],[0,3],[1,4]])}")
    ...
    print(f"Accounts Merge: {accounts_merge(accounts)}")
    
    # Test 5: Redundant Connection
    print(f"Find Redundant Connection([[1,2],[1,3],[2,3]]): {find_redundant_connection([[1,2],[1,3],[2,3]])}")
    
    # Test 6: Most Stones Removed
    print(f"Remove Stones([[0,0],[0,1],[1,0],[1,2],[2,1],[2,2]]): {remove_stones([[0,0],[0,1],[1,0],[1,2],[2,1],[2,2]])}")
    
    # Test 7: Satisfiability of Equality Equations
    print(f"Equations Possible(['a==b','b!=a']): {equations_possible(['a==b','b!=a'])}")
    
    # Test 8: Swim in Rising Water
    swim_grid = [[0,2],[1,3]]
    print(f"Swim in Water: {swim_in_water(swim_grid)}")
    
    # Test 9: Connecting Cities
    print(f"Minimum Cost(3, [[1,2,5],[1,3,6],[2,3,1]]): {minimum_cost(3, [[1,2,5],[1,3,6],[2,3,1]])}")
    
    # Test 10: Make Connected
    print(f"Make Connected(4, [[0,1],[0,2],[1,2]]): {make_connected(4, [[0,1],[0,2],[1,2]])}")